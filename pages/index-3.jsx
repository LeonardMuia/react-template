...
import Popular from "@/src/components/popularServices";
import {
  partnerSliderOne,
  sliderActive3Item,
            ...
            <div className="col-xl-5">
              ...
              <div className="features-content-box pr-lg-70 mb-50">
                ...
                <div className="section-title mb-30">
                  ...
                  <h2>Explore Kenya's Real Adventure &amp; Travels</h2>
                </div>
                <p className="mb-30">
                Nested along the equator, this enchanting country boasts a 
                rich tapestry of landscapes, from the breathtaking savannahs to the 
                ...
                <div className="row pl-lg-70">
                  <div className="col-md-6">
                    ...
                    <div className="fancy-icon-box-two mb-30">
                      <div className="icon">
                        <i className="far fa-hotel" style={{color: "#FA4836",}}/>
                      ...
                      <div className="text">
                        ...
                        <p>
                        Kenya offers a diverse range of 
                        hotels, from luxury lodges overlooking the Maasai Mara to cozy accommodations in bustling Nairobi. 
                        </p>
                        <div className="read-more">
                          <a href="">Read More </a> 
                          <i className="fa-light far fa-chevron-right" />
                          <style jsx>{`
                                .fa-chevron-right {
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="fancy-icon-box-two mb-30">
                      <div className="icon">
                        <i className="fa-light far fa-utensils" />
                      </div>
                      <div className="text">
                        <h3 className="title">Restaurants</h3>
                        <p>
                        Kenyan restaurants showcase the rich
                         culinary diversity of the country, blending traditional flavors with international cuisines. 
                        </p>
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="fancy-icon-box-two mb-30">
                      ...
                      <div className="text">
                        ...
                        <p>
                          SKenya's destinations range from the iconic Maasai Mara 
                          for unparalleled wildlife experiences to the historic Lamu Island 
                        </p>
                        <div className="read-more">
                          <a href="">Read More </a> 
                          <i className="fa-light far fa-chevron-right" />
                  ...
                  <div className="col-md-6">
                    ...
                    <div className="fancy-icon-box-two mb-30">
                      ...
                      <div className="text">
                        ...
                        <p>
                        Kenya offers an array of activities for visitors, including classic safaris 
                        in renowned reserves, 
                        </p>
                        <div className="read-more">
                          <a href="">Read More </a> 
                          <i className="fa-light far fa-chevron-right" />
